...
using ClothingRecycler.Desktop.Helpers;
using ClothingRecycler.Desktop.Models;

namespace ClothingRecycler.Desktop.OrderWindows
{
    public sealed partial class OutboundOrderConfirmationWindow : Window
    {
        private readonly OrderExportService _orderExportService;
        private bool _isExporting;

        public OutboundOrderConfirmationWindow(OutboundOrderConfirmationModel confirmation)
        {
